...
const menu = [
  {
    ...
    subCategory: "Beer",
    description:
      "Stella Artois is a classic Belgian lager, golden in color with a floral, hop aroma, well-balanced fruity malty sweetness, crisp hop bitterness and a soft dry finish. All natural ingredients give Stella Artois a clean, crisp palate.",
    img: "",
    videoId: "Gv1gV8LyKms",
  ...
  },
  {
    ...
    subCategory: "wine",
    description:
      "This Cabernet Sauvignon welcomes you with aromas of cedar, dark cherry compote, and dried tobacco leaves. Deliciously balanced and laced with flavors of blackberry pie, cinnamon, and allspice, this wine maintains approachable tannins and shows through to a savory finish.",
    img: "",
    videoId: "c0holnMELMU",
    date: new Date(Date.now()),
    price: 10,
  },
  {
    ...
    subCategory: "wine",
    description:
      "The 2017 ARTEMIS Cabernet Sauvignon offers inviting aromas of ripe raspberry, boysenberry and dark cherry along with hints of cedar and spice. The mid-palate is pleasant and round with flavors of plum, dark chocolate, dried fruit and a touch of toasted oak. The finish is rich and lingering.",
    img: "",
    videoId: "-f1pWL5Lm6I",
    date: new Date(Date.now()),
    price: 10,
